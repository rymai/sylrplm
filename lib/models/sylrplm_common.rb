...
module Models
  module SylrplmCommon
    ...
    #  - true avec recherche du prochain numero de sequence
    #  - false sans recherche du prochain numero de sequence
     def set_default_values(next_seq)
      fname = "#{self.class.name}.#{__method__}"
      LOG.info (fname) {"Try to use set_default_values_with..."}
