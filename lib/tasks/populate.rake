...
def create_parts
  25.times do |i|
    Part.create!(ident: "part#{i + 100_000}", designation: "des part#{i}")
  end
end
...
def create_documents
  ...
  Part.all.each do |part|
    10.times do |i|
      part.documents.create!(ident: "doc#{i + 1_000_000 + (part.id - 1) * 10}", designation: "des document#{i}")
    end
  end
end
