...
module SYLRPLM
  ...
  THEME_DEFAULT = 'white'
  TREE_ORDER = %w[forum document part project customer].freeze
  TREE_UP_ORDER = %w[document part project customer].freeze
  TREE_GROUP = false
  TREE_RELATION_STOP = %w[FROM_REVISION FROM_DUPLICATE].freeze
