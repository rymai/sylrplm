class PLMValidation < OpenWFE::ProcessDefinition
  ...
  cursor do
    ...
    plm Ruote::PlmParticipant, :task=>"plm_validate",:step=>"init"
    ...
    plm Ruote::PlmParticipant, :task=>"plm_validate", :step=>"review"
   ...
   # back :if =>  '${f:ok} == false' && '${f:comment_valideur} == ""'
    ...
    plm Ruote::PlmParticipant, :task=>"plm_validate", :step=>"exec"
