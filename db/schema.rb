...
ActiveRecord::Schema.define(version: 0) do
  ...
  add_index 'checks', %w[checkobject_plmtype checkobject_id], name: 'index_checks_on_object_and_object_id'
  ...
  add_index 'definitions_roles', %w[definition_id role_id], name: 'index_definitions_roles_on_role_id_and_definition_id', unique: true
  ...
  add_index 'groups_users', %w[user_id group_id], name: 'index_groups_users_on_user_id_and_group_id', unique: true
  add_index 'groups_users', %w[group_id user_id], name: 'index_groups_users_on_group_id_user_id', unique: true
  ...
  add_index 'groups_volumes', %w[volume_id group_id], name: 'index_groups_volumes_on_volume_id_and_group_id', unique: true
  ...
  add_index 'notifications', %w[forobject_type forobject_id], name: 'index_notifications_on_object_type_and_object_id'
  ...
  add_index 'projects_users', %w[project_id user_id], name: 'index_projects_users_on_project_id_and_user_id', unique: true
  add_index 'projects_users', %w[user_id project_id], name: 'index_projects_users_on_user_id_project_id', unique: true
  ...
  add_index 'relations', %w[child_plmtype child_typesobject_id], name: 'index_relations_on_child_plmtype_and_child_typesobject_id'
  add_index 'relations', %w[father_plmtype father_typesobject_id], name: 'index_relations_on_father_plmtype_and_father_typesobject_id'
  ...
  add_index 'relations_views', %w[view_id relation_id], name: 'index_relations_views_on_view_id_relation_id', unique: true
  add_index 'relations_views', %w[relation_id view_id], name: 'index_relations_views_on_relation_id_view_id', unique: true
  ...
  add_index 'roles_users', %w[role_id user_id], name: 'index_roles_users_on_role_id_and_user_id', unique: true
  ...
  add_index 'statusobjects', %w[forobject rank name], name: 'index_statusobjects_on_object_and_rank_and_name', unique: true
  add_index 'statusobjects', %w[forobject typesobject_id], name: 'index_statusobjects_on_object_typesobject_id'
  ...
  add_index 'statusobjects_nexts', %w[statusobject_id other_statusobject_id], name: 'index_stobjs_nexts_on_stobj_id_and_other_stobj_id', unique: true
  ...
  add_index 'statusobjects_previous', %w[statusobject_id other_statusobject_id], name: 'index_stobjs_prevs_on_stobj_id_and_other_stobj_id', unique: true
  ...
  add_index 'subscriptions_typesobjects', %w[subscription_id typesobject_id], name: 'index_subs_typesobjs_on_sub_id_and_typesobj_id', unique: true
  ...
  add_index 'projects_subscriptions', %w[subscription_id project_id], name: 'index_subs_projects_on_sub_id_and_project_id', unique: true
  ...
  add_index 'groups_subscriptions', %w[subscription_id group_id], name: 'index_sub_groups_on_sub_id_and_group_id', unique: true
  ...
  add_index 'typesobjects', %w[forobject name], name: 'index_typesobjects_on_object_and_name', unique: true
