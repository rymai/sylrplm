...
class Notification < ActiveRecord::Base
  ...
  :class_name => "User"
	...
	def self.get_conditions(filter)
		...
		ret = {}
		if filter.present?
			ret[:qry] = "forobject_type LIKE :v_filter or notify_users LIKE :v_filter or #{qry_responsible_id} or #{qrys_object_ident} or event_type LIKE :v_filter or to_char(event_date, 'YYYY/MM/DD')  LIKE :v_filter or to_char(notify_date, 'YYYY/MM/DD') LIKE :v_filter or to_char(updated_at, 'YYYY/MM/DD') LIKE :v_filter"
